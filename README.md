# Performance Peru Data Warehouse Guide

Documentación de **lógica de negocio** del ETL legacy (Evolta + Sperant → Spark → BigQuery → Power BI).

Sitio publicado: https://performancerealstate.mintlify.app
